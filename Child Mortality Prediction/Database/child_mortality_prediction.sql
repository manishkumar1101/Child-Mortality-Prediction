...
--
-- Host: localhost
-- Generation Time: Jul 28, 2022 at 08:29 AM
...
--
-- Database: `child_mortality_prediction`
--
CREATE DATABASE IF NOT EXISTS `child_mortality_prediction` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `child_mortality_prediction`;
...
--
-- Table structure for table `remote_user_child_mortality_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_child_mortality_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `week` varchar(300) NOT NULL,
  `total_deaths` varchar(300) NOT NULL,
  `Child_Age` varchar(300) NOT NULL,
  `Disease` varchar(300) NOT NULL,
  `Medicine_Status` varchar(300) NOT NULL,
  `Life_expectancy` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_child_mortality_type`
--

INSERT INTO `remote_user_child_mortality_type` (`id`, `country`, `start_date`, `end_date`, `days`, `year`, `week`, `total_deaths`, `Child_Age`, `Disease`, `Medicine_Status`, `Life_expectancy`, `RID`, `Prediction`) VALUES
(1, 'India', '17-02-20', '23-02-20', '7', '2020', '8', '3059', '5', 'Influenza', 'No', '57.69', '[''RIDRD60054'']', 'High Death Ratio'),
(2, 'India', '02-03-20', '08-03-20', '7', '2020', '10', '2996', '5', 'Meningococcal ACWY', 'Yes', '52.65', '[''RIDRD34506'']', 'Low Death Ratio'),
(3, 'India', '06-04-20', '12-04-20', '7', '2020', '15', '3140', '5', 'Tetanus', 'Yes', '79.84', '[''RIDRD132135'']', 'High Death Ratio'),
(4, 'India', '22-02-21', '28-02-21', '7', '2021', '8', '3048', '5', 'Tetanus', 'Yes', '77.66', '[''180101'']', 'High Death Ratio');
...
(2, 'Manjunath', 'tmksmanju132@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,4th Cross,Vijayanagar', 'Male');
...
(232, 'Naive Bayes', '61.388286334056396'),
(233, 'SVM', '61.17136659436009'),
(234, 'Logistic Regression', '62.364425162689805'),
(235, 'KNeighborsClassifier', '42.19088937093275'),
(236, 'Random Forest Classifier', '61.06290672451193'),
(237, 'SVM', '61.27982646420824');
...
(8, 'High Death Ratio', '75.0'),
(9, 'Low Death Ratio', '25.0');
