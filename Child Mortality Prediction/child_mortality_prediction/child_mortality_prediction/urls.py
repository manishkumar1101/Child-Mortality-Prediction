"""child_mortality_prediction  URL Configuration
...
from child_mortality_prediction  import settings
...
urlpatterns = [
    ...
    url(r'^Child_Mortality_prediction_Type/$', remoteuser.Child_Mortality_prediction_Type, name="Child_Mortality_prediction_Type"),
    ...
    url(r'^View_Child_Mortality_Prediction_Type_Ratio/$', serviceprovider.View_Child_Mortality_Prediction_Type_Ratio, name="View_Child_Mortality_Prediction_Type_Ratio"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^View_Child_Mortality_Prediction_Type/$', serviceprovider.View_Child_Mortality_Prediction_Type, name="View_Child_Mortality_Prediction_Type"),
